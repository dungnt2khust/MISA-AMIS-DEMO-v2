...
namespace MISA.Amis.Core.Services
{
    public class CustomerService : BaseService<Customer>, ICustomerService
    {
        ...
        {
            _serviceResult.Data = _customerRepository.GetNewCode();
        ...
        {
            _serviceResult.Data = _customerRepository.GetByFilter(pageSize, pageNumber, filterString);
            _serviceResult.IsValid = _serviceResult.Data != null;
            return _serviceResult;
        }
        ...
        {
            var employees = _customerRepository.ExportCustomers();
            ...
            using (var package = new ExcelPackage(stream))
            {
                ...
                //Tạo tiêu đề cho bảng chứa thông tin khách hàng (ở hàng 3)
                ...
                //Đổ thông tin khách hàng lên các hàng của bảng
                int recordIndex = 4;
