...
namespace MISA.Amis.Infrastucture.Repository
{
    public class CustomerRepository : BaseRepository<Customer>, ICustomerRepository
    {
        ...
        public FilterResponse GetByFilter(int pageSize, int pageNumber, string filterString)
        {
            ...
            var storeFilter = "Proc_GetFilterCustomers";
            var storeCount = "Proc_GetCountCustomers";
            ...
            var customers = _dbConnection.Query<object>(storeFilter, commandType: CommandType.StoredProcedure, param: parameters);
        ...
        {
            string storeName = "Proc_GetNewCustomerCode";
        ...
        /// ModifiedBy: NTDUNG (01/09/2021)
        public IEnumerable<Employee> ExportCustomers()
        {
            var proceduce = "Proc_Exportcustomers";
            var customers = _dbConnection.Query<Employee>(proceduce, commandType: CommandType.StoredProcedure);
            return customers;
        }
