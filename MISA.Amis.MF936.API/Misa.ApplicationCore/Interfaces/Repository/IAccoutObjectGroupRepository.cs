...
{
    public interface IAccountObjectGroupRepository : IBaseRepository<AccountObjectGroup>
    {
        /// <summary>
        ...
        object GetAccountObjectGroupFilterPaging(string warehouseFilter, int pageIndex, int pageSize);
    }
}
